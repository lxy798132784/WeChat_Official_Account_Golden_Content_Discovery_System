...
QString UiText::text(const QString& key, UiLanguage language) {
  ...
  static const QHash<QString, QString> zh = {
      ...
      {"discover.start_keyword_auto", "开始关键词自动采集"}, {"discover.auto_search", "自动搜索"}, {"discover.generate_search_urls", "生成搜索入口"}, {"discover.import_results", "导入结果文件"}, {"discover.enqueue_hot", "爆款结果加入队列"}, {"discover.keywords_placeholder", "粘贴关键词，每行一个，例如 人工智能工具、本地生活、跨境电商、虚拟货币交易。"},
