...
QString UiText::text(const QString& key, UiLanguage language) {
  static const QHash<QString, QString> en = {
      ...
      {"data.title", "Title"}, {"data.account", "Account"}, {"data.category", "Category"}, {"data.read", "Read"}, {"data.like", "Like"}, {"data.old_like", "Old Like"}, {"data.comment", "Comment"}, {"data.freq", "30d Frequency"}, {"data.score", "Score"}, {"data.url", "URL"},
  ...
  static const QHash<QString, QString> zh = {
      ...
      {"data.title", "标题"}, {"data.account", "账号"}, {"data.category", "分类"}, {"data.read", "阅读"}, {"data.like", "点赞"}, {"data.old_like", "在看"}, {"data.comment", "评论"}, {"data.freq", "30天频率"}, {"data.score", "评分"}, {"data.url", "链接"},
